  ...
  <div class="container">
        <div class="panel panel-primary">
            <div class="panel-heading">!Ya haces parte de SoccerFile ®!</FONT>
                ...
                <div class="progress">
                    <div class="progress-bar progress-bar-info progress-bar-striped active" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width:80%"> 80%
                    </div>
                </div>
            ...
            <div class="jumbotron">
                    <h3>Solo nos faltan 2 pasos</h3>
                    <p>El primero de ellos es que nos cuentes tu historial como jugador, </p>
            </div>
                ...
                <form action="CreacionPefilJugador6.php" metod="POST" class="form-inline">
                    ...
                    <div class="form-group">
                        ...
                        <select name="PositionAtTeam" id="PositionAtTeam" class="form-control" required="required">
                            ...
                            <option value="Defensa por izquierda">Defensa por izquierda</option>
                            <option value="Defensa por derecha">Defensa por derecha</option>
