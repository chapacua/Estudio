...
<table width="80%" border="0">
  ...
  <tr>
    <td bgcolor="#CCCCCC" colspan="4"><center><p class="style7"><b>HABILIDADES Y FORTALEZAS</b></p></center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor="#CCCCCC" colspan="4"><center><p class="style7"><b>ESPECIALISTA EN</b></p></center></td>
  </tr>
  <tr>
    <td><input type="text" size="20"></td>
    <td><input type="text" size="20"></td>
  ...
  <tr>
    <td bgcolor="#CCCCCC" colspan="4"><center><p class="style7"><b>EQUIPOS ANTERIORES</b></p></center></td>
  </tr>
  <tr>
    <td><input type="text" size="20"></td>
    <td><input type="text" size="20"></td>
