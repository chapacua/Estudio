...
<table width="80%" border="0">
  ...
  <tr>
    <td bgcolor="#CCCCCC" colspan="4"><center><p class="style7"><b>EXPERIENCIA</b></p></center></td>
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor="#CCCCCC" colspan="4"><center><p class="style7"><b>EQUIPOS DE CONTACTO</b></p></center></td>
  </tr>
  <tr>
    <td><input type="text" size="20"></td>
    <td><input type="text" size="20"></td>
  ...
  <tr>
    <td bgcolor="#CCCCCC" colspan="4"><center><p class="style7"><b>JUGADORES ACTUALES</b></p></center></td>
  </tr>
  <tr>
    <td><input type="text" size="20"></td>
    <td><input type="text" size="20"></td>
  ...
  <tr>
    <td bgcolor="#CCCCCC" colspan="4"><center><p class="style7"><b>JUGADORES ANTERIORES</b></p></center></td>
  </tr>
  <tr>
    <td><input type="text" size="20"></td>
    <td><input type="text" size="20"></td>
