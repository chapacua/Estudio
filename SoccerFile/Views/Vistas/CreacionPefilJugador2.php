      ...
      <div class="col-xs-12">
        <div class="panel panel-primary">
          <div class="panel-heading">!Ya haces parte de Soccer File ®!</FONT>
            ...
            <div class="jumbotron">
              <h3>Ya sabemos un poco más a cerca de ti, pero aún falta!</h3>
...
<form role="form" class="form-horizontal"  method="POST" action="CreacionPefilJugador3.php">
...
<div class="form-group">
        ...
        <select class="form-control" name="Language1" id="Language" required>
            <option value="">Seleccione</option>
